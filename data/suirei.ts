...
export const OPENING_DOC = [
  ...
  { key: "g3", label: "根拠3", value: "2026/09/12 14:08。CAM-総合-E01。車両 白バン", pair: "van" },
  { key: "who", label: "確認者", value: "未確定", pair: "" },
...
export const DOC_MAP = [
  ...
  { id: "van", left: "搬入口の白バン", right: "東側搬入口の車両" }
] as const;
